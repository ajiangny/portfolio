/**
 * galleryData.js — Gallery Section Artwork Data
 *
 * Array of artwork objects displayed in the Gallery grid.
 * Each artwork has an id, optional title, medium label (shown on hover),
 * and a source path to the image in /public/art/.
 */
export const artworks = [
  { id: 13, title: '', medium: 'Concept Art', src: '/art/art13.webp' },
  { id: 1, title: '', medium: 'Digital Illustration', src: '/art/art1.webp' },
  { id: 2, title: '', medium: 'Digital Illustration', src: '/art/art2.webp' },
  { id: 5, title: '', medium: 'Concept Art', src: '/art/art5.webp' },
  { id: 7, title: '', medium: 'Digital Illustration', src: '/art/art7.webp' },
  { id: 4, title: '', medium: 'Digital Illustration', src: '/art/art4.webp' },
