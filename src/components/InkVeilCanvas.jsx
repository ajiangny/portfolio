/**
 * InkVeilCanvas.jsx — GPU ink-dissolve veil (mobile companion to the SVG
 * turbulence veils in LoadingScreen.jsx / PageTransition.jsx)
 *
...
export default function InkVeilCanvas({ t, colorTop, colorBottom, seed = 7, style }) {
