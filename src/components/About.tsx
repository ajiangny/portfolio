...
const lerpRect = (a: Box, b: Box, t: number): Box => ({
...
export default function About() {
  ...
  const finalBoxRef = useRef<Box | null>(null)
  useEffect(() => {
    const measure = () => {
