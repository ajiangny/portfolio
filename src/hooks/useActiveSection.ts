/**
 * useActiveSection.ts — Which section holds the viewport centre, and whether
...
export default function useActiveSection(): ActiveSectionState {
  const lenisRef = useLenisContext()
  const [state, setState] = useState<ActiveSectionState>({ index: 0, settled: true })
