/**
 * useScrollTimeline.ts — Section Scroll Progress Hook
 *
 ...
 *
 * @param containerRef - Ref to the tall scrolling wrapper (e.g. 400vh div).
 * @param activeVh - Scroll travel in viewport-heights over which progress
